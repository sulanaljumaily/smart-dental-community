  ...
  const conversations = [
    {
      ...
      lastMessage: "متى سيكون الجسر جاهز؟",
      time: "10:30 ص",
      unread: 2,
      online: true,
      avatar: "ع",
    },
    {
      ...
      lastMessage: "شكراً على جودة العمل المتميزة",
      time: "أمس",
      unread: 0,
      online: false,
      avatar: "م",
    },
    {
      ...
      lastMessage: "المواد الخزفية وصلت اليوم",
      time: "أمس",
      unread: 1,
      online: true,
      avatar: "ش",
    },
    {
      ...
      type: "PLATFORM",
      name: "الدعم الفني",
      lastMessage: "تم حل مشكلتك بنجاح",
      time: "2024-01-18",
      unread: 0,
      online: true,
      avatar: "د",
  ...
  const messages = [
    {
      id: "1",
      senderId: "other",
      text: "السلام عليكم، نحتاج جسر لثلاثة أسنان",
      time: "9:00 ص",
      type: "text",
    },
    {
      id: "2",
      senderId: "me",
      text: "وعليكم السلام، نعم متوفر. ما هو اللون المطلوب؟",
      time: "9:05 ص",
      type: "text",
    },
    {
    ...
    },
    {
      id: "4",
      senderId: "me",
      text: "ممتاز، سيكون جاهز خلال 3 أيام",
      time: "9:15 ص",
      type: "text",
    },
    {
              ...
              <>
                ...
                <div className="border-t p-4">
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <Button size="icon" className="bg-gradient-to-br from-purple-500 to-blue-600">
