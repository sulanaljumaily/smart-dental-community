      ...
      <section className="relative py-12 md:py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            ...
            <Card className="bento-card lg:col-span-2 bg-gradient-to-r from-pink-500 via-rose-600 to-red-600 text-white border-none overflow-hidden relative group cursor-pointer">
              <div className="absolute top-0 left-0 w-40 h-40 bg-white/10 rounded-full -translate-y-1/2 -translate-x-1/2"></div>
              <div className="absolute bottom-0 right-0 w-32 h-32 bg-white/10 rounded-full translate-y-1/2 translate-x-1/2"></div>
              <CardContent className="p-6 md:p-8 relative z-10">
                <div className="flex flex-col md:flex-row items-center gap-6">
                  ...
                  <div className="flex-1 text-center md:text-right">
                    <h3 className="text-2xl md:text-3xl font-bold mb-2">اكتشف أفضل العيادات</h3>
                    <p className="text-white/95 text-base md:text-lg leading-relaxed">
                      ابحث عن عيادات قريبة منك واحجز موعدك بسهولة وسرعة
                    </p>
                  </div>
                  <Button
                    variant="secondary"
                    size="lg"
                    className="font-bold shadow-lg hover:shadow-xl transition-all duration-300 group/btn"
                    asChild
                  >
                    <Link href="/services" className="flex items-center gap-2">
                      استكشف الآن
